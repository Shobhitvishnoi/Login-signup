...
class CutomerRegistration1 extends StatefulWidget {
  @override
  _CutomerRegistration1State createState() => _CutomerRegistration1State();
}

class _CutomerRegistration1State extends State<CutomerRegistration1> {
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      child: Text("Start your Carrer as a Delivery Partner",style: TextStyle(fontSize: 13,backgroundColor: Colors.lightBlueAccent,),)),
                  FlatButton(

                      child: Text(
                        "Get Your Shop Online",
                        style: TextStyle(fontSize: 13,backgroundColor: Colors.lightBlueAccent,),
